    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          <Heading>Nature's Classroom</Heading>
          <Text>
          Dive into a world of wonder and discovery with our series of short lecture videos exploring the intricate tapestry of nature. From the ethereal beauty of clouds painting the sky to the mesmerizing depths of the ocean's abyss, and the vibrant tapestry of wildlife that calls our planet home, each video offers a fascinating glimpse into the wonders of the natural world. Join us as we unravel the mysteries of nature and deepen our understanding of the diverse ecosystems that shape our planet.
          </Text>
        </VStack>
      </VStack>
      <VStack
